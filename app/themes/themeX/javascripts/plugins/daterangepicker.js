        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>';
        if(typeof options.buttonContainer !="undefined" && options.buttonContainer){
          DRPTemplate+='<div class="rp_b_c"><center><button class="applyBtn" disabled="disabled" type="button"></button></center>';
        }else{
          DRPTemplate+='<center><button class="applyBtn" disabled="disabled" type="button"></button></center>';
        }

      DRPTemplate+= '</div></div></div>';
        ...
        if(typeof options.classLists!="undefined"){
          this.container.addClass(options.classLists)
        }
