...
RSpec.describe 'Facebook Ads Details', type: :request do
  ...
  describe 'GET /fb_ads/ads' do
    it 'works' do
      data = data = { insights: [{ clicks: '45' }], total_clicks: 35 }
      allow_any_instance_of(FbAds::AdsController).to receive(:ad_insights).and_return(data)
      get fb_ads_ads_path, params: { id: ad_account.business_id, start_date: '2017-12-01', end_date: '2017-12-31' }
      expect(response).to have_http_status(200)
    end

    it 'returns not found if date range missing' do
      get fb_ads_ads_path, params: { id: ad_account.business_id }
