  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if(typeof options.buttonContainer !="undefined" && options.buttonContainer){
          DRPTemplate+='<div class="rp_b_c"><button class="applyBtn" disabled="disabled" type="button"></button>' +
            '<button class="cancelBtn" type="button"></button></div>';
        }else{
          DRPTemplate+='<button class="applyBtn" disabled="disabled" type="button"></button>&nbsp;' +
