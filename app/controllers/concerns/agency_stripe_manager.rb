module AgencyStripeManager
  ...
  def create_stripe_customer
    ...
    unless current_agency.update_attributes(customer_id: @customer.id)
      render json: {
        status: 401, data: nil,
        message: current_agency.errors.full_messages.to_sentence
      } and return
    end
    @customer
  end
