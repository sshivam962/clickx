clickxApp.factory('CallRailCharts', [
  'MonthNames',
  function(MonthNames) {
    var CallRailCharts = {};

    CallRailCharts.call_status_pie_chart_data = function(status_data) {
      return {
        chart: {
        ...
        series: [
          {
            ...
            data: [
              ['Answered', status_data.answered_calls || 0],
              ['Missed', status_data.missed_calls || 0]
            ]
          }
        ],
    ...
    // CallCharts.unique_calls_bar_chart_data = function(unique_calls_data, greater_than_five) {
    //   return {
    //     chart: {
    //       type: 'column',
    //       height: 200,
    ...
    //       pointFormat: '<tr><td style="color:{series.color};padding:0">Times Called: </td>' +
