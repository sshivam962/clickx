...
class KeywordMonthlyRankingsView < ApplicationRecord
  self.table_name = 'keyword_monthly_rankings_view'
  ...
  def self.refresh
    ActiveRecord::Base.connection.execute("DROP MATERIALIZED VIEW IF EXISTS keyword_monthly_rankings_view")
