...
RSpec.describe 'Facebook Ads Campaigns', type: :request do
  ...
  describe 'GET #index' do
    it 'works' do
      ...
      allow_any_instance_of(FbAds::CampaignsController).to receive(:campaigns).and_return(data)
      get fb_ads_campaigns_path, params: { id: ad_account.business_id, start_date: '2017-12-01', end_date: '2017-12-31' }
      expect(response).to have_http_status(200)
    end

    it 'returns not found if date range missing' do
      get fb_ads_campaigns_path, params: { id: ad_account.business_id }
