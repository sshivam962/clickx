  ...
  function EditableController($scope, $attrs, $element, $parse, editableThemes, editableIcons, editableOptions, $rootScope, $compile, $q) {
    ...
    self.render = function() {
      ...
      if(self.buttons !== 'no') {
        ...
        self.buttonsEl.append(self.submitEl).append(self.cancelEl).append(self.linkEl);
...
angular.module('xeditable').factory('editableIcons', function() {
  ...
  var icons = {
    ...
    default: {
      ...
      'bs3': {
        ok: 'fa fa-check pr-xs',
        cancel: 'fa fa-times pr-xs'
      }
    },
    external: {
      'font-awesome': {
...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'bs3': {
      formTpl:     '<form class="form-inline editable-wrap" role="form"></form>',
      noformTpl:   '<span class="editable-wrap"></span>',
      controlsTpl: '<div class="editable-controls form-group pl-n input-group" ng-class="{\'has-error\': $error}"></div>',
      inputTpl:    '',
      errorTpl:    '<div class="editable-error help-block" data-ng-if="$error" data-ng-bind="$error"></div>',
      buttonsTpl:  '<div class="editable-buttons btn-group col-md-12"></div>',
      submitTpl:   '<button type="submit" class="btn btn-white btn-lg btn-raised btn-sm"><i class="fa fa-check pr-xs"></i></button>',
      cancelTpl:   '<button type="button" class="btn btn-white btn-lg btn-raised btn-sm" ng-click="$form.$cancel()">'+
                     '<i class="fa fa-times pr-xs"></i>'+
                   '</button>',
      linkTpl:   '<a class="btn btn-white btn-raised btn-sm fright m-n" target="_blank" ng-href ="{{history_url(keyword.id)}}">'+'<i class="fa fa-link"></i>'+ '</a>',
